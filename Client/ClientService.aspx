<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="ClientService.aspx.cs" Inherits="AutomativeZoneCarAtoZ.Client.ClientService" %>
...
<li class="float-md-start p-3 px-4"><a href="ClientContactUs.aspx">Contact Us</a></li>
 <li class="float-md-start p-3 px-4"><a href="ClientAppointment.aspx">Appointment</a></li>
            ...
            <div class="container-fluid big-padding bg-gray big-padding">
                <div class="container-xl">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-1.jpg" alt="">
                            <h6 class="fw-bolder fs-5 py-2">Car Oil Change</h6>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-2.jpg" alt="">
                            <h6 class="fw-bolder fs-5 py-2">Filters & Exhaust</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque condimentum nisl ac lacus rutrum aliquam. Duis scelerisque feugiat nisl, et dictum felis congue non.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-3.jpg" alt="">
                            <h6 class="fw-bolder fs-5 py-2"> Clutch & Brakes</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque condimentum nisl ac lacus rutrum aliquam. Duis scelerisque feugiat nisl, et dictum felis congue non.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-4.jpg" alt="">
                            <h6 class="fw-bolder fs-5 py-2">Auto Diagnostics</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque condimentum nisl ac lacus rutrum aliquam. Duis scelerisque feugiat nisl, et dictum felis congue non.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-5.jpg" alt="">
                            <h6 class="fw-bolder fs-5 py-2">Car Oil Change</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque condimentum nisl ac lacus rutrum aliquam. Duis scelerisque feugiat nisl, et dictum felis congue non.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <img class="rounded shadow mb-3" src="assets/images/service/img-service-6.jpg" alt="">

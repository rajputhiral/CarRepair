<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="EditAppointment.aspx.cs" Inherits="AutomativeZoneCarAtoZ.Admin.EditAppointment" %>
  ...
  <div class="leftcolumn">
    ...
    <div class="card">
        ...
        <br />
            ...
            <tr>
             <td>            
             <asp:Button ID="Button1" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" runat="server" Text="Update" Height="40px" OnClick="Button1_Click" Width="50px" />
              </td>
            </tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AdminPrice.aspx.cs" Inherits="AutomativeZoneCarAtoZ.Admin.WebForm1" %>
...
<body>
  ...
  <div class="leftcolumn">    
    ...
    <tr>  
        ...
        <td>
        <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" DataTextField="Services"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
            ...
            <td>
                <div class="form-group">   <h5>Price</h5></td>
        </div>

        <td>
<asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" placeholder="Price"></asp:TextBox></td>
    ...
    <asp:TemplateField HeaderText="Edit">
        <ItemTemplate>
            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl='<%#"EditAdminPrice.aspx?PrId="+Eval("PrId") %>'>Edit</asp:LinkButton>
        </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Delete">
        <ItemTemplate>
            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="del" CommandArgument='<%# Eval("PrId") %>' OnClientClick="return confirm('Are you sure you want to delete this?')" >Delete</asp:LinkButton>
        </ItemTemplate>
    </asp:TemplateField>
</Columns>

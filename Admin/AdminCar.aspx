<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AdminCar.aspx.cs" Inherits="AutomativeZoneCarAtoZ.Admin.AdminCar" %>
...
<div class="row">
  <div class="leftcolumn">
    ...
    <div class="card">
        ...
        <br />
            ...
            <tr>
             ...
             <td>             
            <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" placeholder="Service" Height="50px" Width="500px"></asp:TextBox>    
          </td> 
            </tr> 
            <tr>
             <td>            
    ...
    <asp:TemplateField HeaderText="Service Name">
        <ItemTemplate>
            <asp:Label ID="Label1" runat="server" Text='<%# Eval("CarMakeModel") %>'></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
               
    <asp:TemplateField HeaderText="Edit">
        <ItemTemplate>
            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl='<%#"EditAdminCar.aspx?CId="+Eval("CId") %>'  >Edit</asp:LinkButton>
        </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Delete">
        <ItemTemplate>
            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="del" CommandArgument='<%# Eval("CId") %>' OnClientClick="return confirm('Are you sure you want to delete this?')" >Delete</asp:LinkButton>
        </ItemTemplate>
    </asp:TemplateField>
</Columns>
